...
define('EMAIL', 'jcsong.89@gmail.com');

 // Site URL (base for all redirections):
define ('BASE_URL', 'http://localhost/userregistration/');

/******* IMPORTANT WHEN MOVING THIS API TO A DIFFERENT SITE. Simply change the values of the
follow`ing definition in order to match the current environment*/
// Location of the MySQL connection script:
define ('MYSQL', '..\user_connect.php');
...
$message .= "Date/Time: " . date('nj-Y H:i:s') . "\n";
