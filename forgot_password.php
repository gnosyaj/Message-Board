...
if (!empty($_POST['email'])) {
  ...
  if ($uid) { // If everything's OK.
    ...
    // Send an email:
    $body = "Your password to log into <whatever site> has been temporarily changed
            to '$p'. Please log in using this password and this email address.
    ...
    echo '<h3>Your password has been changed. You will receive the new, temporary password at
    ...
    echo '<p class="error">Your password could not be changed due to a system
...
<fieldset>
  <p><b>Email Address:</b><input type="text" name="email" size="20" maxlength="60"
    value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>"></input></p>
</fieldset>
<div align="center"><input type="submit" name="submit" value="Reset My Password"></input></div>
</form>
