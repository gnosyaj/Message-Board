...
<fieldset>
<p><b>Email Address:</b> <input type="text" name="email" size="20" maxlength="60"></input></p>
<p><b>Password:</b> <input type="password" name="pass" size="20" maxlength="20"></input></p>
<div align="center"><input type="submit" name="submit" value="Login"></input></div>
</fieldset>
</form>
